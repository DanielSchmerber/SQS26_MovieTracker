...
![whitebox overallsystem](diagrams/whitebox_overall_system_diagram.png)
...
![backend](diagrams/backend_whitebox_diagram.png)
...
The database schema is defined in backend/sqs-movietracker/models/ using SQLAlchemy declarative models:

![model diagram](diagrams/models_overall_whitebox_diagram.png)
